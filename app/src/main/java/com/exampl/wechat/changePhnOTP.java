...
import com.exampl.weChat.databinding.ActivityChangePhnOtpBinding;
...
public class changePhnOTP extends AppCompatActivity {
    ActivityChangePhnOtpBinding binding;
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityChangePhnOtpBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        auth = FirebaseAuth.getInstance();
        database = FirebaseDatabase.getInstance();
        binding.otpView1.requestFocus();

//        from changePhoneNumber
...
////
//                        to UPDATE THE CONTACT OF THE USER the USER with the Previous credentials and with the new one we need to use
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                           ...
                                                           public void onComplete(@NonNull Task<Void> task) {
                                                               if (task.isSuccessful()) {
                                                                   ...
                                                                   Toast.makeText(changePhnOTP.this, "UPDATED", Toast.LENGTH_SHORT).show();

                                                                   Intent intent = new Intent(changePhnOTP.this, settingsActivity.class);
                                                                   intent.putExtra("newPhnNumber", phoneNumber);
                                                                   startActivity(intent);
                                                                   finish();
                                                               } else {
                                                                   // Failed
                                                                   Toast.makeText(changePhnOTP.this, "Failed to register", Toast.LENGTH_SHORT).show();
                                                               }
                                                           }
                                                       }
                                );
...
//                                .addOnCompleteListener( changePhnOTP.this, new OnCompleteListener<AuthResult>() {
//                                    @Override
...
//
//                                        } else {
//                                            Toast.makeText(changePhnOTP.this, "Authentication failed\nAlready Registered.",
...
//                        contact updated in  databse
                        ...
                        Toast.makeText(changePhnOTP.this, "Please check Internet Connection", Toast.LENGTH_SHORT).show();

                    }
//                    Toast.makeText(OTPActivity.this, "OTP VERIFY", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(changePhnOTP.this, "Please Enter OTP Correctly", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                                   to locate the error in the Toast use e.getmessage
                                Toast.makeText(changePhnOTP.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }

                            @Override
                            public void onCodeSent(@NonNull String NEWbackendOTP, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                getOTPBackend = NEWbackendOTP;
                                Toast.makeText(changePhnOTP.this, "OTP sent Successfully", Toast.LENGTH_SHORT).show();
                            }
                        }
                );
